...
const Home = () => {
	return (
		<div>
			<Head>
				<title>the easiest way to rent</title>
			</Head>
			<div className='h-screen bg-gray-200 flex flex-col font-sans items-center'>
				<header className='bg-indigo-700 w-full px-4 py-3 flex justify-center border-b-2 border-pink-500'>
					<div className='max-w-4xl w-full'>
						<div className='flex items-center justify-between text-pink-400'>
							...
							<button
								type='button'
								className='block text-gray-400 hover:text-gray-100 focus:text-white focus:outline-none sm:hidden md:hidden"'>
						...
						<div className='mt-4'>
							<h1 className='text-2xl text-indigo-100 capitalize'>
								want to learn Tailwindcss?
							</h1>
							<p className='mt-1 text-sm text-indigo-200'>
								Tailwind is the fast growing utility first CSS framework. Let's
							...
							<div className='relative my-4'>
								<div className=''>
									<a
										href='#'
										className='capitalize rounded-full px-4 py-2 bg-pink-500 text-indigo-100 text-xs font-semibold'>
										Enroll Now!
									</a>
								</div>
								<div className='absolute right-0 border-2 rounded-full border-pink-500 flex items-center justify-center'>
									<img
										src='logo.png'
										alt='logo'
				...
				<main className='mt-16 w-full flex flex-col items-center'>
					<div className='max-w-4xl mx-4'>
						<h2 className='pb-1 text-xl font-bold text-indigo-700 border-b border-indigo-500'>
							How It Works
						</h2>
						...
						<h2 className='mt-5 pb-1 text-xl font-bold text-indigo-700 border-b border-indigo-500'>
							Advantages
						</h2>
						<div className='sm:-mx-2 flex flex-col sm:flex-row'>
							<div className='mt-4 sm:w-1/3'>
								<div className='bg-white p-8 h-full border-b-4 border-pink-700 rounded-lg flex flex-col items-center'>
									<div className='bg-gray-300 text-indigo-700 w-16 rounded-full p-2'>
										<svg
							...
							<div className='mt-4 sm:w-1/3'>
								<div className='bg-white p-8 h-full border-b-4 border-pink-700 rounded-lg flex flex-col items-center sm:mx-2'>
									<div className='bg-gray-300 text-indigo-700 w-16 rounded-full p-2'>
										<svg
											className='h-12 w-12 fill-current'
											xmlns='http://www.w3.org/2000/svg'
							...
							<div className='mt-4 sm:w-1/3'>
								<div className='bg-white p-8 h-full border-b-4 border-pink-700 rounded-lg flex flex-col items-center sm:mx-2'>
									...
									<div className='font-bold'>Mobile Friendly</div>
									<div className='text-center mt-2 text-sm text-gray-600'>
										Modern applications demand mobile-friendly & Tailwind's
										responsive modifiers make it eas
									</div>
								</div>
							</div>
						</div>
					</div>
					<div className='bg-blue-800 py-12 mt-12 w-full flex flex-col items-center border-t border-black'>
						<h2>sign up to get the free PDF</h2>
					</div>
				</main>
				<footer className='bg-blue-800 w-full text-center pb-8 '>
					<p className='text-xs'>Copyright © 2021 gudsurvey Inc</p>
				</footer>
			</div>
		</div>
	)
